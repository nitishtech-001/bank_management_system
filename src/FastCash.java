        ...
        if (strPin.isEmpty()) {
            ...
            try {
                ...
                if (balance.next()) {
                    ...
                    if (Long.parseLong(strBalance) < Long.parseLong(strAmount) + 100) { //used +100 for minimum balance
                    ...
                    String query = "INSERT INTO transaction VALUES ('" + cardNo + "','FastCash','" + strAmount + "','"
                            + date + "','"+time+"' )";
